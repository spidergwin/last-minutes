...
const standaloneComponents: Components = {
  ...
  h4: ({ className, ...props }) => (
    <h4 className={cn("aui-md-h4 mt-2 mb-1 scroll-m-20 text-sm font-medium first:mt-0 last:mb-0", className)} {...props} />
  ),
  h5: ({ className, ...props }) => (
  ...
  pre: ({ className, ...props }) => (
    <pre className={cn("aui-md-pre border-border/50 bg-muted/30 overflow-x-auto rounded-lg border p-3 text-xs leading-relaxed my-2", className)} {...props} />
  ),
  code: ({ className, children, ...props }) => {
    ...
    return (
      <code
        className={cn(
          isInline && "aui-md-inline-code border-border/50 bg-muted/50 rounded-md border px-1.5 py-0.5 font-mono text-[0.85em]",
          className
        )}
        {...props}
      >
